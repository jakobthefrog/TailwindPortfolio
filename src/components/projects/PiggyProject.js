    ...
    <div class=" bg-slate-900 max-w-sm rounded overflow-hidden shadow-lg">
      ...
      <div className="px-6 py-4">
        <div class=" text-slate-100 font-bold text-xl mb-2">
          Piggy Bankers: Elderly Engagement Game
        </div>
        <p className=" text-slate-300 text-base">
          Read about how I tackled re-imagining and helping develop the most
          popular game on the iN2L engagement system; replacing a game used by
